    ...
    <Layout>
          ...
          <View style={commonStyles.results}>
              <FlatList
                ...
                data={listverb}
                renderItem={({ item }) => (
                <TouchableOpacity style={[commonStyles.listFrame]} onPress={() => navigation.push('Conjugations', { infinitive: item.inf, dist: item.dist, gropmodel: '', descmodel: item.desc, typenav:'fav', variety:variety })}>
